...
fun Customer.getOrderedProductsAsSequence(): Sequence<Product> = orders.flatMap{ it.products }.asSequence()

fun main() {
    println(testShop.customers[1].getOrderedProductsAsSequence().toList())
}